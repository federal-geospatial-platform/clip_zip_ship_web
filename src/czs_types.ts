...
/** Valid keys for the CLIP ZIP SHIP category */
export type CZSUIEventKey =
    | 'UI_START_DRAWING'
    | 'UI_CLEAR_DRAWING'
    | 'UI_START_EXTRACTION'
    | 'UI_ORDER_HIGHER_STARTED'
    | 'UI_ORDER_LOWER_STARTED'
    | 'UI_COLLECTION_CHECKED'
;

/**
 * Event names
 */
export type CZSUIEventStringId =
    | 'czs/ui/UI-START_DRAWING'
    | 'czs/ui/UI-CLEAR_DRAWING'
    | 'czs/ui/UI-START_EXTRACTION'
    | 'czs/ui/UI-ORDER_HIGHER_STARTED'
    | 'czs/ui/UI-ORDER_LOWER_STARTED'
    | 'czs/ui/UI-COLLECTION_CHECKED'
;

export const CZS_EVENT_NAMES_UI: Record<CZSUIEventKey, CZSUIEventStringId> = {
    /**
     * Event is triggered when the user wants to start drawing on the map
     */
    UI_START_DRAWING: 'czs/ui/UI-START_DRAWING',

    /**
     * Event is triggered when the user wants to clear drawing on the map
     */
    UI_CLEAR_DRAWING: 'czs/ui/UI-CLEAR_DRAWING',

    /**
     * Event is triggered when the user wants to start extracting features on the map
     */
    UI_START_EXTRACTION: 'czs/ui/UI-START_EXTRACTION',

    /**
     * Event is triggered when the user wants to raise the layer z-index
     */
    UI_ORDER_HIGHER_STARTED: 'czs/ui/UI-ORDER_HIGHER_STARTED',

    /**
     * Event is triggered when the user wants to lower the layer z-index
     */
    UI_ORDER_LOWER_STARTED: 'czs/ui/UI-ORDER_LOWER_STARTED',

    /**
     * Event is triggered when the user checks/unchecks a collection
     */
    UI_COLLECTION_CHECKED: 'czs/ui/UI-COLLECTION_CHECKED'
};
